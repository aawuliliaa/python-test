...
from task_manage.my_ansible.run_playbook import PlaybookRunner
def main():
    ...
    ar = PlaybookRunner(temphosts_dict)
    ar.run_playbook("/etc/ansible/playbook/test.yml")
    print("changed==============", ar.get_playbook_result().get("changed"))
    print("status==============", ar.get_playbook_result().get("status"))
    print("skipped==============", ar.get_playbook_result().get("skipped"))
    print("failed==============", ar.get_playbook_result().get("failed"))
    ...
    print("ok==============", ar.get_playbook_result().get("ok"))
    ...
    print("unreachable==============",ar.get_playbook_result().get("unreachable"))
